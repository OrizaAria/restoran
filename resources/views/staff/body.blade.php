                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('staff/images/faces/face1.jpg" alt="image') }}" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('staff/images/faces/face2.jpg" alt="image') }}" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('staff/images/faces/face5.jpg" alt="image') }}" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('staff/images/faces/face3.jpg" alt="image') }}" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('staff/images/faces/face4.jpg" alt="image') }}" />
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="preview-list">
                        <div class="preview-item border-bottom">
                            <div class="preview-thumbnail">
                                <img src="{{ asset('staff/images/faces/face6.jpg" alt="image') }}"
                        ...
                        <div class="preview-item border-bottom">
                            <div class="preview-thumbnail">
                                <img src="{{ asset('staff/images/faces/face8.jpg" alt="image') }}"
                                    class="rounded-circle" />
                            </div>
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                        ...
                        <div class="preview-item border-bottom">
                            <div class="preview-thumbnail">
                                <img src="{{ asset('staff/images/faces/face9.jpg" alt="image') }}"
                                    class="rounded-circle" />
                            </div>
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                        ...
                        <div class="preview-item border-bottom">
                            <div class="preview-thumbnail">
                                <img src="{{ asset('staff/images/faces/face11.jpg" alt="image') }}"
                                    class="rounded-circle" />
                            </div>
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel"
                        ...
                        <div class="item">
                            <img src="{{ asset('staff/images/dashboard/Rectangle.jpg') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('staff/images/dashboard/Img_5.jpg') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ asset('staff/images/dashboard/img_6.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="d-flex py-4">
                        <div class="preview-list w-100">
                            <div class="preview-item p-0">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('staff/images/faces/face12.jpg') }}" class="rounded-circle"
                                        alt="">
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
